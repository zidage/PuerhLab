...
- `rec709_bt1886.icc`: generated with LittleCMS 2 as the Pu-erh Lab Rec.709 / BT.1886 export profile approximation.
...
- `xyz_gamma26.icc`: generated with LittleCMS 2 for Pu-erh Lab's XYZ / gamma 2.6 export path.
...
- Generated profiles were created locally with LittleCMS 2 using the color primaries and transfer functions required by Pu-erh Lab's current export UI combinations.
