...
class IPipelineStage {
 ...
 public:
  ...
  explicit IPipelineStage(PipelineStageName stage, bool enable_cache) : _stage(stage), _enable_cache(enable_cache) {}
...
class StreamablePipelineStage : public IPipelineStage {
 private:
  ...
  std::shared_ptr<TileScheduler> _tile_scheduler;
 ...
 public:
  ...
  auto GetTileScheduler() -> std::shared_ptr<TileScheduler> { return _tile_scheduler; }
