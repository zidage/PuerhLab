...
namespace puerhlab {
class EditHistoryService : public ServiceInterface<EditHistoryService, std::shared_ptr<EditHistory>,
                                                   EditHistoryMapperParams, EditHistoryMapper,
                                                   sl_element_id_t> {
 public:
  ...
  auto        GetEditHistoryByFileId(const sl_element_id_t file_id)
