...
项目网站：[English](https://zidage.github.io/PuerhLab/en/) | [简体中文](https://zidage.github.io/PuerhLab/zh/)
...
- Ultra HDR 依赖：上游 `libultrahdr` 源码子模块位于 `pu-erh_lab/src/third_party/libultrahdr`，由顶层 CMake 以 git submodule 方式接入
...
在配置 Pu-erh Lab 之前，先确保 `Lensfun` 和 `libultrahdr` 子模块都已经拉取：
