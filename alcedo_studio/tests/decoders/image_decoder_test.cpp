...
//   alcedo::DecoderScheduler scheduler(8, std::make_shared<alcedo::ConcurrentBlockingQueue<std::shared_ptr<alcedo::Image>>>(64));
...
//       L"D:\\Projects\\alcedo\\alcedo\\tests\\resources\\sample_"
